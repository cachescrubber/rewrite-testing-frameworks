...
class TestNgAssertFalseToAssertThatTest implements RewriteTest {
    ...
    public void defaults(RecipeSpec spec) {
        spec
          ...
          .recipe(new TestNgAssertFalseToAssertThat());
    }
          ...
          java(
            """
              ...
              public class MyTest {
                  @Test
                  public void test() {
                      org.testng.Assert.assertFalse(notification() != null && notification() > 0);
                      org.testng.Assert.assertFalse(notification() != null && notification() > 0, "The notification should be negative");
                  }
                  private Integer notification() {
                      return 1;
                  }
